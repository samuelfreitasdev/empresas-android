package br.com.sf.empresas_android.ui.widgets
...
import br.com.sf.empresas_android.ui.util.ViewUtils
...
class ContainersLayout : FrameLayout {
    ...
    private fun animateInFrameDetails() {
        ...
        ViewUtils.onLaidOut(frameDetails) {
            ...
            val translate =
                ofFloat(frameDetails, View.TRANSLATION_Y, frameDetails.height * 0.3f, 0f)
    ...
    private fun animateOutFrameDetails() {
        ViewUtils.onLaidOut(frameDetails) {
            if (frameDetails.isShown) {
                ...
                val translate =
                    ofFloat(frameDetails, View.TRANSLATION_Y, 0f, frameDetails.height * 0.3f)
